...
public enum ResponseCodes {
    ...
    CREATED_FAILED(4,"04","No se ha podido registrar el curso"),
    UPDATE_FAILED(5,"05","No se ha podido actualizar los datos del curso"),
    DELETE_FAILED(6,"06","No se ha podido borrar el curso");
