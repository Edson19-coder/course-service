package com.ejls.service.course.config;
...
@EnableJpaRepositories(
    ...
    basePackages = { "com.ejls.service.course.repository.base"}
)
public class DBBaseConfig {
    ...
    public LocalContainerEntityManagerFactoryBean baseEntityManagerFactory(EntityManagerFactoryBuilder builder, @Qualifier("baseDataSource") DataSource dataSource) {
        return builder.dataSource(dataSource).packages("com.ejls.service.course.domain.base").persistenceUnit("base").build();
    }
